...
class JsonEditor extends PureComponent {
    ...
    componentDidMount() {
        ...
        // var xmlStr = json2xml(jsonObj);
        // console.log(xmlStr);

        // console.log(xmlStr+11111);
        // ON


        console.log('<?xml version="1.0" encoding="utf-8"?>' +(json2xml(jsonObj)),"(json2xml(jsonObj))")
     ...
     objectToXml(object) {
        ...
        for (var prop in object) {
            ...
            if (typeof object[prop] == "object")
                xml += this.objectToXml(new Object(object[prop]));
            else
                xml += object[prop];
            xml += "<!--" + prop + "--\>";
        }
